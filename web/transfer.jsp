            ...
            <center>
              <div class="col_1_of_list span_1_of_list login-right login-right1">
			  	<h3>Transfer Money</h3>
                                ...
                                <form  name="login" method="post" action="trans.jsp" onsubmit="return valid();">
                                   <table>
                                       <tr>
                                        <td> <span> Account No &nbsp;&nbsp;</span></td>
                                        <td><input type="text" name="tacc" id="deposit" size="30" required></td>
                                      </tr>
                                      <tr>
                                           <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                           <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><input type="text" name="num3" id="deposit" size="30" required></td>
                                      </tr>
                                      <tr>
                                           <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                           <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
